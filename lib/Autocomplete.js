...
class Autocomplete extends React.Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (prevState.highlightedIndex !== null) {
      ...
      return this.ensureHighlightedIndex
    }
    if (nextProps.autoHighlight && (this.props.value !== nextProps.value || prevState.highlightedIndex === null)) {
      return this.maybeAutoCompleteText
    }
  }
